...
class Logger:
    ...
    def __init__(self):
        self.log = None
        self.dir_path = os.path.expanduser('~/.config/Nuki')
    ...
    def create_working_file_log(self, user_name, working_file):
        ...
        if os.path.exists(working_file):
            self.log.debug(f"\"{user_name}\" create Nuke file in \"{working_file}\"")
        else:
            self.log.warning(f"\"{user_name}\" failed to create Nuke file")
